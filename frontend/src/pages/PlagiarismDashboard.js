                        ...
                        <div className="p-4">
                            ...
                            <div className="space-y-2">
                                {notifications.filter(n => !n.is_read).slice(0, 5).map(notif => (
                                    <div key={notif.id} className="plag-box flex items-center justify-between p-3 rounded-lg" style={{ background: 'rgba(30, 35, 44, 0.8)' }}>
                            ...
                            <div className="space-y-2">
                                {courses.map(course => (
                                    <button
                                        ...
                                        className={`plag-box w-full text-left p-3 rounded-lg transition-all cursor-pointer border-none ${
                                ...
                                <div className="surface-card rounded-xl p-5 mb-6">
                                    ...
                                    {exercises.length > 0 ? (
                                        <div className="space-y-3">
                                            {exercises.map(ex => (
                                                <div key={ex.id} className="plag-box flex items-center justify-between p-4 rounded-lg" style={{ background: 'rgba(30, 35, 44, 0.6)' }}>
                                                    <div className="flex-1">
                                            ...
                                            {scanResult.error ? (
                                                ...
                                                <>
                                                    ...
                                                    <div className="grid grid-cols-3 gap-4 mb-4">
                                                        <div className="plag-box text-center p-3 rounded-lg" style={{ background: 'rgba(30, 35, 44, 0.8)' }}>
                                                    ...
                                                    {scanResult.matches?.length > 0 && (
                                                        <div className="space-y-2">
                                                            {scanResult.matches.map((match, idx) => (
                                                                <div key={idx} className="plag-box flex items-center justify-between p-3 rounded-lg" style={{ background: 'rgba(30, 35, 44, 0.8)' }}>
                                                                    <div className="flex items-center gap-3">
                                ...
                                <div className="surface-card rounded-xl p-5">
                                    ...
                                    {reports.length > 0 ? (
                                        <div className="space-y-3">
                                            {reports.map(report => (
                                                <div key={report.id}
                                                     className="plag-box flex items-center justify-between p-4 rounded-lg cursor-pointer transition-all hover:scale-[1.01]"
